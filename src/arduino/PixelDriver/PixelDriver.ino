...
// The serial buffer consists of five bytes:
 ...
 */
void setup() {
    Serial.begin(19200);  // Open Serial interface
 ...
 * Read the five byte message from the Serial buffer and set the LED of the
 * requested index to the requested color.
 */
void loop() {
    // Wait for serial data (at least five bytes in the buffer)
